...
export const MARKETING_PAGES: MarketingPage[] = [
  // ── Produit ─────────────────────────────────────────────────────
  {
    ...
    eyebrow: 'Produit',
    description: 'Tout ce que Mache Kay BOSAL offre pour digitaliser votre coopérative haïtienne : comptes, prêts, change, caisse, rapports.',
    section: 'Produit',
    icon: 'Sparkles',
  },
  {
    ...
    eyebrow: 'Produit',
    description: 'De l’inscription au premier décaissement : découvrez les 4 étapes pour déployer Mache Kay BOSAL dans votre coopérative.',
    section: 'Produit',
    icon: 'Workflow',
  },
  {
  ...
  },
  {
    ...
    title: 'API',
    eyebrow: 'Ressources',
    description: 'Intégrez Mache Kay BOSAL à vos outils internes via notre API REST — endpoints comptes, prêts, transactions, webhooks.',
    section: 'Ressources',
    icon: 'Code2',
  },
  {
  ...
  },
  {
    ...
    title: 'Partenaires',
    eyebrow: 'Entreprise',
    description: "Cabinets comptables, intégrateurs, fédérations coopératives — rejoignez l'écosystème Mache Kay BOSAL.",
    section: 'Entreprise',
    icon: 'Handshake',
  },
  {
    ...
    eyebrow: 'Entreprise',
    description: 'Les règles du jeu pour utiliser Mache Kay BOSAL : droits, devoirs, responsabilités. Rédigées en français clair.',
    section: 'Entreprise',
    icon: 'FileText',
  },
  {
    ...
    eyebrow: 'Entreprise',
    description: 'Vos données, vos règles. Comment Mache Kay BOSAL collecte, stocke et protège les informations de votre coopérative.',
    section: 'Entreprise',
    icon: 'Lock',
  },
]
