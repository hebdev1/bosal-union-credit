import { Vault, ArrowLeftRight, AlertTriangle, LockKeyhole, Scale } from 'lucide-react'
  ...
  return (
    <PageShell slug={SLUG}>
      <Section title="Caisse et coffre : contrôle total">
        <p>
          Chaque ouverture de caisse, chaque transfert vers le coffre — tracé,
          horodaté, réconcilié. La fin des écarts inexpliqués.
        </p>
      </Section>
