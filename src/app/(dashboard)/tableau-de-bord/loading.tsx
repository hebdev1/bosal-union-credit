    ...
    <div className="px-6 py-6 space-y-8 max-w-[1280px] mx-auto w-full" aria-label="Chargement…" role="status">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        <div
          ...
          style={{ background: '#111318', border: '1px solid #252A36', height: 360 }}
        >
          <div className="px-5 py-4 border-b" style={{ borderColor: '#252A36' }}>
            <div className="h-4 w-40 rounded skeleton" />
          </div>
          <div className="divide-y" style={{ borderColor: '#1a1f2e' }}>
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="flex items-center gap-4 px-5 py-3.5" style={{ borderTop: '1px solid #1a1f2e' }}>
